        		...
        		<div class="row course_details_inner">
        			<div class="col-lg-8">
        				<div class="c_details_img">
        					<img class="img-fluid" src="img/css-overview.jpg" alt="">
        				</div>
						<div class="container">
								<div class="about_details">
                  <p>CSS adalah singkatan dari Cascading Style Sheets. CSS perlu dipelajari untuk membuat halaman web menjadi lebih cantik dan menarik. CSS digunakan untuk merepresentasikan file HTML yang sudah dibuat.</p>
								</div>
						</div>
        			</div>
        			<div class="col-lg-4">
        				<div class="c_details_list">
        					<ul class="list">
        						...
        						<li><a href="#">Jumlah video <span>24</span></a></li>
        					</ul>
        					<a class="main_btn" href="css.php">Mulai Belajar</a>
        				</div>
        			</div>
        		</div>
        	</div>
