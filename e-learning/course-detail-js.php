        		...
        		<div class="row course_details_inner">
        			<div class="col-lg-8">
        				<div class="c_details_img">
        					<img class="img-fluid" src="img/js-overview.jpg" alt="" width="750" height="350">
        				</div>
						<div class="container">
								<div class="about_details">
                  <p>Untuk membuat sebuah website sebenarnya bisa hanya dengan menggunakan HTML dan CSS. Namun dengan Javascript kita dapat menambahkan sedikit animasi pada halaman yang kita buat dengan HTML dan CSS. Javascript adalah bahasa pemrograman yang digunakan untuk membuat website menjadi lebih interaktif.</p>
								</div>
						</div>
        			</div>
        			<div class="col-lg-4">
        				<div class="c_details_list">
        					<ul class="list">
        						...
        						<li><a href="#">Jumlah video <span>30</span></a></li>
        					</ul>
        					<a class="main_btn" href="javascript.php">Mulai Belajar</a>
        				</div>
        			</div>
        		</div>
        	</div>
