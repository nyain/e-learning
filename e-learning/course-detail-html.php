        		...
        		<div class="row course_details_inner">
        			<div class="col-lg-8">
        				<div class="c_details_img">
        					<img class="img-fluid" src="img/html-overview.jpg" alt="">
        				</div>
						<div class="container">
								<div class="about_details">
					             <p>HTML adalah bahasa pemrograman yang berfungsi untuk membuat struktur dasar website. HTML bertugas menyusun kerangka halaman web.</p>
								</div>
						</div>
        			</div>
        			<div class="col-lg-4">
        				<div class="c_details_list">
        					<ul class="list">
        						...
        						<li><a href="#">Jumlah video <span>20</span></a></li>
        					</ul>
        					<a class="main_btn" href="html.php">Mulai Belajar</a>
        				</div>
        			</div>
        		</div>
        	</div>
