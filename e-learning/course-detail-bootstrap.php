        		...
        		<div class="row course_details_inner">
        			<div class="col-lg-8">
        				<div class="c_details_img">
        					<img class="img-fluid" src="img/bootstrap-overview.jpg" alt="" width="750" height="350">
        				</div>
						<div class="container">
								<div class="about_details">
					             <p>Bootstrap adalah open-source framework front-end yang bebas untuk merancang situs web dan aplikasi web. Framework ini berisi template desain berbasis HTML dan CSS untuk tipografi, formulir, tombol, navigasi dan komponen antarmuka lainnya, serta juga ekstensi opsional JavaScript.</p>
								</div>
						</div>
        			</div>
        			<div class="col-lg-4">
        				<div class="c_details_list">
        					<ul class="list">
        						...
        						<li><a href="#">Jumlah video <span>8</span></a></li>
        					</ul>
        					<a class="main_btn" href="bootstrap.php">Mulai Belajar</a>
        				</div>
        			</div>
        		</div>
        	</div>
